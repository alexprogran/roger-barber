...
const Home = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Calcula a opacidade da sombra baseada no scroll
    ...
    <section 
      ...
      <div className="home-hero-content">
        <div className="home-content-wrapper">
          {/* Logo e Card alinhados horizontalmente */}
          ...
          {/* Botão Nossos Serviços - Apenas Mobile */}
          <div className="home-services-button-wrapper">
            <a
              href="#services"
              className="home-services-button btn-barbershop"
            >
              Nossos Serviços
            </a>
          </div>
      ...
      {/* Social Media Floating Buttons - Desktop Only */}
